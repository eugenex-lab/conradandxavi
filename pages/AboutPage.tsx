...
const AboutPage: React.FC = () => {
  return (
    <div className="bg-beige dark:bg-navy-dark">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-3xl font-light text-navy/70 dark:text-gray-300 leading-relaxed mb-12 reveal-up stagger-2 max-w-2xl">
              Since {FIRM_INFO.established}, we have cultivated a practice
              defined by one singular metric: the strategic success of our
              clients.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="relative">
              <div className="luxury-text-outline text-[160px] font-serif font-bold opacity-10 absolute -top-32 -left-10 select-none hidden md:block">
                MASTER
              </div>
              ...
              <div className="space-y-12">
                <div className="flex items-start space-x-8">
                  ...
                  <div>
                    <h4 className="text-2xl font-serif font-bold mb-3 italic">
                      Calculated Precision
                    </h4>
                    <p className="text-gray-400 font-light leading-relaxed text-lg">
                      Every legal motion is a calculated step toward a larger
                      strategic outcome. We do not react; we orchestrate.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-8">
                  ...
                  <div>
                    <h4 className="text-2xl font-serif font-bold mb-3 italic">
                      Client-Centric Dominance
                    </h4>
                    <p className="text-gray-400 font-light leading-relaxed text-lg">
                      Our clients are not just cases; they are partners in
                      success. We protect their interests with a ferocity that
                      is unmatched.
                    </p>
                  </div>
                </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -right-10 bg-gold p-12 hidden lg:block max-w-[320px] shadow-3xl">
                ...
                <p className="text-navy font-serif italic text-xl leading-snug">
                  "Legal expertise is common. Strategic foresight is rare. We
                  offer the latter."
                </p>
                <div className="mt-6 text-[10px] font-bold uppercase tracking-widest text-navy/60">
                  Senior Partner, Conrad & Xavi LP
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Mission/Vision - Elite Typographic Split */}
      <section className="py-32 bg-[#00152e] text-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-20 gap-x-24">
            {/* The Mission */}
            <motion.div
              ...
              className="relative border-t border-white/10 pt-16 group"
            >
              <div className="absolute top-0 right-0 -mt-10 text-[180px] font-serif font-medium text-white/[0.03] select-none group-hover:text-gold/[0.05] transition-colors duration-700">
                01
              </div>
              ...
              <h3 className="text-4xl md:text-5xl font-serif font-medium mb-10 leading-[1.1] tracking-tight">
                Definitive Legal <br />
                <span className="italic text-white/50 tracking-normal">
                  Conduit.
                </span>
              </h3>
              <p className="text-lg text-white/60 font-light leading-relaxed max-w-md">
                To serve as the definitive legal conduit for those seeking
                excellence in the Nigerian and global markets, providing
                strategic representation that transcends standard legal
                practice.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-lg text-white/60 font-light leading-relaxed max-w-md">
                To be universally recognized as the gold standard for Nigerian
                legal practice, where every interaction is characterized by
                integrity, innovation, and unparalleled results.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-40 bg-white dark:bg-navy-dark overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20">
          <div className="text-center mb-24">
            ...
            <h2 className="text-5xl md:text-8xl font-serif font-medium dark:text-white">
              A Decade of <span className="italic">Impact.</span>
            </h2>
          </div>
              ...
              {[
                {
                  year: "2014",
                  title: "The Genesis",
                  desc: "Conrad & Xavi LP was established in Lagos, setting a new benchmark for corporate legal consultancy.",
                  img: "https://images.unsplash.com/photo-1497366754035-f200968a6e72?q=80&w=800",
                },
                {
                  year: "2018",
                  title: "Strategic Growth",
                  desc: "Expanded into the Ikoyi financial district, specializing in high-end real estate and private equity.",
                  img: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=800",
                },
                {
                  year: "2022",
                  title: "Global Integration",
                  desc: "Pivoted to include cross-border litigation and tech-driven legal advisory for international firms.",
                ...
                >
                  ...
                  >
                    ...
                    <h4 className="text-4xl font-serif font-medium mb-6 dark:text-white leading-tight">
                      {item.title}
                    </h4>
                    <p className="text-navy/60 dark:text-gray-400 font-light text-lg leading-relaxed max-w-sm md:ml-auto md:mr-0 mr-auto ml-auto">
                      {item.desc}
                    </p>
                  </div>
            ...
            {[
              {
                ...
                icon: Shield,
                desc: "Transparency is our standard.",
              },
              {
                title: "Strategic Mastery",
                icon: Award,
                desc: "We calculate every outcome.",
              },
              {
                title: "Fierce Loyalty",
                icon: Users,
                desc: "We protect our own.",
              },
              {
                title: "Bold Innovation",
                icon: Target,
                desc: "Leading through evolution.",
              },
            ].map((val, idx) => (
              <div
                key={idx}
                className="group border-l border-navy/5 dark:border-white/5 pl-10"
              >
                <div className="text-gold mb-10 group-hover:translate-x-2 transition-transform">
                  <val.icon size={44} strokeWidth={1.5} />
                </div>
                <h4 className="text-2xl font-serif font-bold mb-4 dark:text-white italic">
                  {val.title}
                </h4>
                <p className="text-sm text-navy/50 dark:text-gray-500 font-light leading-relaxed">
                  {val.desc}
                </p>
              </div>
            ))}
